...
#define XBee_RX_BUFFER_SIZE                 (400u)
...
/* Only if RX is enabled */
    ...
    uint16 XBee_GetRxBufferSize(void)
                                                            ;
...
extern uint8 XBee_initVar;
    ...
    extern volatile uint16 XBee_rxBufferRead;
    extern volatile uint16 XBee_rxBufferWrite;
...
#define XBee_INIT_TX_INTERRUPTS_MASK \
                                  (uint8)((0 << XBee_TX_STS_COMPLETE_SHIFT) \
                                        | (1 << XBee_TX_STS_FIFO_EMPTY_SHIFT) \
